...
export default {
  ...
  computed: {
     ...
     */
    progressBar() {
      return this.$store.state.messages.actionProgress;
    },
     ...
     */
    hasErrors() {
      return !!this.$store.state.messages.errors.length;
    },
     ...
     */
    filesCount() {
      return this.$store.getters[`${this.activeManager}/filesCount`];
    },
     ...
     */
    directoriesCount() {
      return this.$store.getters[`${this.activeManager}/directoriesCount`];
    },
     ...
     */
    filesSize() {
      return this.bytesToHuman(this.$store.getters[`${this.activeManager}/filesSize`]);
    },
     ...
     */
    selectedCount() {
      return this.$store.getters[`${this.activeManager}/selectedCount`];
    },
     ...
     */
    selectedFilesSize() {
      return this.bytesToHuman(this.$store.getters[`${this.activeManager}/selectedFilesSize`]);
    },
